...
# plt.axvline(109, color="pink", ls=":", label=r"W peak at $z_{\mathrm{eff}}$ = 1 m")
# plt.axvline(915, color="pink", ls=":")
# plt.xlabel("x")
# plt.ylabel("I(x)")
...
# plt.axvline(108, color="pink", ls=":", label=r"W peak at $z_{\mathrm{eff}}$ = 1 m")
# plt.axvline(916, color="pink", ls=":")
# plt.xlabel("x")
# plt.ylabel("I(x)")
...
plt.axvline(110, color="grey", ls=":", label=r"Ag peak at $z_{\mathrm{eff}}$ = 1 m")
plt.axvline(914.5, color="grey", ls=":")
plt.xlabel("x")
plt.ylabel("I(x)")
...
plt.axvline(107, color="pink", ls=":", label=r"TIE+RK -  W peak: 8.1 keV at $z_{\mathrm{eff}}$ = 1 m")
plt.axvline(917, color="pink", ls=":")
plt.legend()
plt.xlabel("x")
plt.ylabel("I(x)")
...
plt.plot(_1m_1[-10], label="TIE+RK")
plt.axvline(107, color="pink", ls=":", label=r"TIE+RK -  Ag peak: 21.99 keV at $z_{\mathrm{eff}}$ = 1 m")
plt.axvline(917, color="pink", ls=":")
plt.legend()
plt.xlabel("x")
plt.ylabel("I(x)")
